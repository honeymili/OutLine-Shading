...
//源码
Shader "Honey/Outline/ZhiHu_TuYueGuan"
{
    Properties
    {
...
//Varyings = v2f
//output = o
//GetVertexPositionInputs 的类型是 
//GetVertexPositionInputs 是 ShaderVariablesFunctions.hlsl里封装的函数  
//从模型空间传输进来的顶点在里面进行坐标空间转换的计算
